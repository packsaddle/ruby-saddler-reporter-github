...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency 'git_diff_parser', '>= 0'
  spec.add_runtime_dependency 'saddler-reporter-support', '>= 0'
  spec.add_runtime_dependency 'saddler-reporter-support-git', '>= 0'
